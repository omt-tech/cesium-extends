import { Color, Cartesian2, LabelStyle, NearFarScalar, HeightReference, LabelCollection, Math as Math$1, Cartesian3, EllipsoidGeodesic, Cartographic, SceneTransforms } from 'cesium';
...
class AreaSurfaceMeasure extends AreaMeasure {
  ...
  calculateDetailSurfaceArea(positions) {
    ...
    positions.forEach((element) => {
      ...
      if (pickResult)
        worldPositions.push(pickResult);
    });
